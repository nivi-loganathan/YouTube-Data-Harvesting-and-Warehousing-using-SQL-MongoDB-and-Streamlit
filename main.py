...
# API key connection
def Api_connect():
    Api_Id = "AIzaSyDDIo-8giX3qR7BhSbcCz4MpcV0qm_Kvcc"
...
# MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://nive:admin@cluster0.gaxkcpe.mongodb.net/?retryWrites=true&w=majority")
